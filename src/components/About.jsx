      ...
      <div className="container mx-auto py-40 flex flex-col-reverse lg:flex-row items-center  gap-20">
        ...
        <div className="my-auto flex flex-col gap-3">
          ...
          <div className="w-full bg-gray-200 h-3 rounded-md">
            <div className="w-full bg-indigo-600 h-3 rounded-md"></div>
          </div>
          <h2 className="text-gray-400 font-medium">Javascript</h2>
          <div className="w-full bg-gray-200 h-3 rounded-md">
            <div className="w-4/6 bg-indigo-600 h-3 rounded-md"></div>
          </div>
          <h2 className="text-gray-400 font-medium">React</h2>
          <div className="w-full bg-gray-200 h-3 rounded-md">
            <div className="w-5/6 bg-indigo-600 h-3 rounded-md"></div>
          </div>
        </div>
      </div>
    </div>
